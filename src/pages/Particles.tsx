 ...
 const particlesItems = [
  {
   name: "Electrons",
    ...
    description2:"Discovered by J.J. Thomson in 1897, these negatively charged particles orbit the atomic nucleus in distinct energy levels, forming the outer shell of atoms. "
  ...
  },
  {
   name: "Positron",
    ...
    description2:"As a member of the lepton family, the positron carries a positive electric charge equal in magnitude to the negative charge of the electron. Discovered by physicist Carl Anderson in 1932, the positron plays a crucial role in the field of particle physics and astrophysics. "
  },
  {
   name: "Photons",
      description:
   ...
   description2: "Photons are crucial for everything related to light, like what we see and how information is transmitted through things like radio waves or Wi-Fi. They also play a role in interesting things like the photoelectric effect. "
  },
  {
   name: "Protons",
      description:
    ...
    description2:"This positive charge counterbalances the negative charge of electrons, which orbit the nucleus. Protons, along with neutrons, contribute to the atomic mass of an element. "
  },
  {
   name: "Antiproton",
      description:
    ...
    description2:"Discovered in 1955, antiprotons are produced in high-energy experiments, often involving particle accelerators. "
  },
  {
   name: "Neutron",
      description:
    ...
    description2:" Discovered by James Chadwick in 1932, neutrons contribute significantly to the stability of atomic nuclei. Their role in nuclear forces helps overcome the repulsion between positively charged protons, effectively binding the nucleus together. "
  },
  {
   name: "Antineutron",
      description:
    ...
    description2: "In contrast to neutrons, which consist of three quarks—two down quarks and one up quark—antineutrons are composed of antiquarks. The most common configuration includes one antistrange quark and two antiup quarks. "
  },
  {
   name: "Neutrino",
   ...
   description:
    ...
    description2:" They are generated in various astrophysical processes, such as nuclear reactions within stars and supernovae explosions, and are produced in abundance by the Sun. "
  },
  {
   name: "AntiNeutrinos",
 ...
 return (
   ...
   <div className="particle-grid">
  {
   particlesItems.map((items, index)=>{
    return <Particle key={index}  description={items.description} heading={items.name} description2={items.description2} />
   })
  }
  <div className='button-div'><button className="button">
